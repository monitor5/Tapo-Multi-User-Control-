...
1. 쉘에서 비밀번호 해시 생성  
   ```bash
   python -m passlib.hash bcrypt -g
   ```
...
| Sprint | 기능 |
|--------|------|
| 2 | **여러 플러그 동시 제어**, Discord 알림, APScheduler 예약 |
| 3 | SQLite 사용자 DB → Postgres 마이그레이션, 역할별 권한 |
| 4 | Prometheus 메트릭 + Grafana 대시보드, 다중 사이트 지원 |

---

### 문의

- Slack : `#tapo-control-dev`  
